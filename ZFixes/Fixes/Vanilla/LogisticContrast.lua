local dr = data.raw
local drI = dr["item"]
local drLC = dr["logistic-container"]

-- Item Icon

drI["logistic-chest-active-provider"].icon = "__ZFixes__/Graphics/Icons/logistic-chest-active-provider.png" 
drI["logistic-chest-buffer"].icon = "__ZFixes__/Graphics/Icons/logistic-chest-buffer.png"
drI["logistic-chest-passive-provider"].icon = "__ZFixes__/Graphics/Icons/logistic-chest-passive-provider.png"
...
drLC["logistic-chest-active-provider"].icon = "__ZFixes__/Graphics/Icons/logistic-chest-active-provider.png" 
drLC["logistic-chest-buffer"].icon = "__ZFixes__/Graphics/Icons/logistic-chest-buffer.png"
drLC["logistic-chest-passive-provider"].icon = "__ZFixes__/Graphics/Icons/logistic-chest-passive-provider.png"
